    ...
    constructor (x,y,z){
        ...
        this.mapimg={
            ...
            'scroll':(v,x,y)=>{
                ...
                console.log(a,'[scrool fn] 이전',this.mapimg.col_x,this.mapimg.col_y)
                ...
                console.log(a,'[scrool fn] 이후',this.mapimg.col_x,this.mapimg.col_y )

                this.mapimg.origin_x *= 배율
                if(v==-1) this.mapimg.origin_y = this.mapimg.origin_y*2 //this.mapimg.origin_y*2+1
                else this.mapimg.origin_y = (this.mapimg.origin_y)/2//(this.mapimg.origin_y - 1)/2
            ...
            'change':()=>{
                ...
                console.log('[change]','[off_x, off_y]',off_x, off_y, '[x_count], y_count', x_count, y_count)
                console.log('for=>',off_x - 1,  (off_x + x_count), off_y - y_count, (off_y + 2))
                ...
                for (var x = off_x - 1; x <= (off_x + x_count); x++)
                    for (var y = off_y - y_count; y <= (off_y + 2); y++){
                        ...
                        //console.log('x,y',x,y,'col x,y', img_col_x, img_col_y, img_col)
                        if (this.mapimg.img_list.includes(img_col)) continue;
                        this.mapimg.img_list.push(img_col);
                        //console.log('32')
                        this.dom.map_in.innerHTML+=`<img style="left: ${img_col_x}px; top: ${img_col_y}px;" src='./img/map/${this.mapimg.L}/${y}/${x}.jpg'>`
                    }
